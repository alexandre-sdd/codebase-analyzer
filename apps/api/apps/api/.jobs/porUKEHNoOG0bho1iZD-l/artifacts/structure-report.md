...
- Resolved local path: `/Users/alexandresepulvedadedietrich/codebase-analyzer/apps/api/apps/api/.jobs/porUKEHNoOG0bho1iZD-l/checkout`
- Scanned at: `2026-02-14T22:26:41.168Z`
...
## Enrichment Status
- Claude enrichment unavailable: Could not resolve authentication method. Expected either apiKey or authToken to be set. Or for one of the "X-Api-Key" or "Authorization" headers to be explicitly omitted
